<template>
    <div class="addVideo padding-aside" style="background:#fff;">        
        <div class="addHeader">
            <h3 class="addHeader-title">360旋转</h3>
        ...
        <el-row :gutter="30" class="m-t">
           ...
           <el-col :span="16">
            <upVideo :inputId='upVideo_inputId' :videoId = 'upVideo_videoId' :parentVideoFileArr='videoArr'></upVideo>
...
export default {
    ...
    data(){
      return {
        ...
        upBtnVisible:false,
        dialogImageUrl:'',
        upVideo_inputId:'360inputId',
        upVideo_videoId:'360videoId',        
        ofileImg:{},        
        imgId:'',
        bigImgList:[],
        bigImgListArr:[],
    ...
    methods: {
        ...
        fileZip(){
            ...
            //console.log(666,this.bigImgListArr);
        },
        imgDelete(id){//删除一张图片
        ...
        zipFiles(){//压缩            
            ...
            if(this.videoArr.length>0){
                if (this.videoArr.length>0) this.zipArr.push(this.videoArr[0]);
        ...
        onSubmit(){//完成            
            ...
            that.axios({
              method:'post',
              url: '/BeautyScience/rotation360s',
              data:{                
                rotation360:{
                    meta_info:{
              ...
              if(res.status == 201){
                ...
                that.$router.push('/media/360Rotation');
              }else{
