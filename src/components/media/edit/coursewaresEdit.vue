<template>
    <div class="zoominEdit padding-aside">
        <div class="addHeader">
            <h3 class="addHeader-title">PPT课件</h3>
            <el-row :gutter="20" type="flex" align='middle' style="margin-right:0;">
                <el-col :span='15' style="display:inline-flex;padding:0;margin-left:10px;">
                    <i class="icon-blue"></i>
                    <el-input v-model="resourceData.title" placeholder="请输入标题"></el-input>
                </el-col>
        ...
        <div class="editContent">
            ...
            <div class="downZip">
                ...
                <div>
                    ...
                    <a :href="resourceData.url" download="test.ppt">下 载</a>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        Cancel(){
            this.$router.push('/media_/PPT')
        },
        submit(){
            let that = this;
            this.axios.patch('/BeautyScience/coursewares/'+this.editId,{
                rotation360:{
